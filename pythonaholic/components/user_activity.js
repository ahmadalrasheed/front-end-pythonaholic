export default function Useractivity(){
    return (
        <div class="w-full container mx-auto my-40">
        <div>

            <div class="bg-white relative shadow-xl w-full mx-auto">
                ...
                <div class="mt-16">
                    ...
                    <div class="w-full">
                        <h3 class="font-bold text-gray-600 text-center px-4">Recent activites</h3>
