    ...
    return (
        <>
            ...
            <div className="flex justify-end inline-block">
                <div class="relative bg-white rounded top-96 border shadow-lg">
                    <div class="rounded-t bg-purple-500">
                    ...
                    <div class="bg-gray-200 md:text-base text-sm border-b p-2 h-24">
                        <p>Would you like To preview you previous Offers?</p>
                        <button onClick={() => usestate(1)} className="py-2 font-bold text-white bg-purple-500 rounded-full mlpx-4 hover:bg-purple-400">
                    Preview
                </button>
                    </div>
                </div>
            ...
            {/* <button onClick={()=>usestate(1)}>View Previous Offers</button> */}
            {state > 0 && <div class="fixed inset-0 overflow-hidden" aria-labelledby="slide-over-title" role="dialog" aria-modal="true">
                                ...
                                <div class="flex-1 py-6 overflow-y-auto px-4 sm:px-6">
                                    <div class="flex items-start justify-between">
                                        ...
                                        <div class="ml-3 h-7 flex items-center">
                                            <button onClick={() => usestate(0)} type="button" class="-m-2 p-2 text-gray-400 hover:text-gray-500">
                                                ...
                                                <li class="py-6 flex">
                                                    ...
                                                    <div class="ml-4 flex-1 flex flex-col">
                                                        ...
                                                        <div class="flex-1 flex items-end justify-between text-sm">
                                                            ...
                                                            <div class="flex">
                                                                <button type="button" class="font-medium text-indigo-600 hover:text-indigo-500"></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </li>
